    ...
    <div class="col-md-12 center-block" style="">
        ...
        <form onsubmit="return searchSubmit()" method="GET" class="form-inline" id="searchToolbar">
        	<div class="form-group">
        		<select name="column" class="form-control" style="margin-left: 15px;">
        			...
        			<option value="realmoney">实付金额</option>
        			<option value="getmoney">分成金额</option>
        			<option value="domain">网站域名</option>
        			<option value="buyer">支付账号</option>
        			<option value="ip">支付IP</option>
        		</select>
        	</div>
        	<div class="form-group">
        	...
        	<div class="input-group input-daterange">
        		...
        		<span class="input-group-addon" onclick="$('#starttime').val('');$('#endtime').val('');" title="清除">
        	...
        	<div class="form-group">
        		<select name="dstatus" class="form-control">
        			...
        			<option value="0">状态未支付</option>
        			<option value="1">状态已支付</option>
        			<option value="2">状态已退款</option>
        			<option value="3">状态已冻结</option>
        		</select>
        	</div>
        	<button type="submit" class="btn btn-primary">&nbsp;搜索&nbsp;</button>
        	<a href="javascript:searchClear()" class="btn btn-default" title="刷新订单列表">
        		<i class="fa fa-refresh"></i>
        	</a>
        	<div class="btn-group" role="group">
        		<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">批量操作 <span class="caret"></span>
        		</button>
        		<ul class="dropdown-menu">
        			<li>
        				<a href="javascript:operation(0)">改未完成</a>
        			</li>
        			<li>
        				<a href="javascript:operation(1)">改已完成</a>
        			</li>
        			<li>
        				<a href="javascript:operation(2)">冻结订单</a>
        			</li>
        			<li>
        				<a href="javascript:operation(3)">解冻订单</a>
        			</li>
        			<li>
        				<a href="javascript:operation(4)">删除订单</a>
        			</li>
        		</ul>
        	</div>
        </form>

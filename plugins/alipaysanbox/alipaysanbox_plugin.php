...
class alipaysanbox_plugin
{
	static public $info = [
		'name'        => 'alipaysanbox', //支付插件英文名称，需和目录名称一致，不能有重复
		'showname'    => '支付宝官方支付沙盒-测试版', //支付插件显示名称
		'author'      => '支付宝', //支付插件作者
		'link'        => 'https://open.alipay.com/develop/sandbox/app', //支付插件作者链接
